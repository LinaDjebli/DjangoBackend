...
from Users.models import CustomUser, Client, Agency, Guide, validate_pdf  ,LANGUAGE_CHOICES
...
class GuideSignupSerializer(serializers.ModelSerializer):
    ...
    guide_languages = serializers.MultipleChoiceField(choices = LANGUAGE_CHOICES , required = True)
    ...
    def create(self, validated_data):
        ...
        guide = Guide.objects.create(
            ...
            guide_languages = validated_data.get('guide_languages'),
...
class ClientSignupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CustomUser
        fields = ['username', 'email', 'first_name', 'last_name', 'password', 'password2', 'phone_number', 'profile_picture']
